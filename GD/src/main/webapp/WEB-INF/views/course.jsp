...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-7">
            ...
            <button class="btn btn-primary" onclick="getCourseSelectMsg(1)">查询</button>
            <button type="button" class="btn btn-primary" onclick="courseAddModel()">新增</button>
        </div>
    </div>
    <!-- 显示表格数据 -->
    <div class="row">
            ...
            <table class="table table-hover" id="stu_table">
                ...
                <c:forEach items="${Course.msgContent.pageInfo.list}" var="item">
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary btn-sm cou_edit_btn"  value="${item.cno}">
                                <span class="glyphicon glyphicon-pencil">修改</span>
                            </button>
                        </td>
                        <td>
                            <button class="btn btn-primary btn-sm cou_delete_btn" value="${item.cno}">
