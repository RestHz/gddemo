...
<div class="modal-header col-sm-10 col-sm-offset-1">
    ...
    <span id="errorMsg" style="color: red;display: none">${ERROR.msgContent.Fail}</span>
</div>
<div class="modal-body col-sm-10">
    <form class="form-horizontal" action="/login" method="post">
        ...
        <div class="form-group" id="empSelectInput">
            ...
            <div class="col-sm-6">
                <select name="role" style="width: 100px;align: center">
        ...
        <div class="modal-footer col-sm-10 col-sm-offset-1">
            <button type="button" class="btn btn-default"><a href="register.jsp">注册</a></button>
